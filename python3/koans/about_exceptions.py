...
class AboutExceptions(Koan):
    ...
    def test_exceptions_inherit_from_exception(self):
        ...
        self.assertEqual('RuntimeError', mro[1].__name__) # interestingly in the notebook python i got different order of mro methods
    ...
    def test_try_clause(self):
        result = None
        try:
            self.fail("Oops") ##xx need to follow up on that fail()
    ...
    def test_finally_clause(self):
        ...
        self.assertEqual('always run', result) #finally alweays runs, its used to for example perform cleanup operations like close nthe file no matter whether try succeeded or whether it was handled by bunch of exceptions
